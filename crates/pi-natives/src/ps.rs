...
//!
//! Provides efficient process tree enumeration and termination without requiring
...
//! - **Windows**: Uses `CreateToolhelp32Snapshot` to build parent-child relationships
//!
//! # Example
//! ```ignore
